...
- Conservative outbound limits: max 30 likes, 0 replies, 0 follows per account per day (operator decision: no auto-follows, no API replies — 403 blocked for new accounts, learned 2026-03-13)
- No auto-replies — all replies are manual. Outbound agent identifies best reply targets and escalates to operator with tweet URL + reply text. daily_replies = 0 permanently. (operator decision, learned 2026-03-13)
